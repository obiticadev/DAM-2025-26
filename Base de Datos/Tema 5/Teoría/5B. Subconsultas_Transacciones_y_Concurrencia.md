...
3. [Problemas asociados al acceso simultáneo a los datos (Bloqueos)](#3-problemas-asociados-al-acceso-simultaneo-a-los-datos)
   ...
   - [3.3. Forzar bloqueos especiales (`FOR UPDATE`)](#33-forzar-bloqueos-especiales-for-update)
...
<a id="33-forzar-bloqueos-especiales-for-update"></a>
### 3.3. Forzar bloqueos especiales (`FOR UPDATE`)
