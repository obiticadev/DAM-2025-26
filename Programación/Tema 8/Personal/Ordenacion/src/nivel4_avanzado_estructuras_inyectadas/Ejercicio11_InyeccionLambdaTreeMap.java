...
public class Ejercicio11_InyeccionLambdaTreeMap {
    ...
    public static void ejercicio() {
        ...
        // TODO: En lugar de un TreeMap tradicional donde las Claves String ("Escudo",
        // "Espada") irían de A-Z...
        ...
        armeria = new TreeMap<>((a, b) -> b.compareTo(a));
        ...
        if (armeria != null && armeria.size() == 3 && armeria.keySet().iterator().next().equals("Maza")) {
            System.out.println(
                    ">> ¡CORRECTO! Has ordenado el mapa léxicamente a la inversa según sus Strings Clave.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(
                    ">> [ERROR] El diccionario debería tener a 'Maza' como primer elemento si usas un orden String de la Z a la A.");
        }
    }
}
