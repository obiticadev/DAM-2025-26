...
public class Ejercicio12_StreamsEnHashSetYQueue {
    ...
    public static void demostracion() {
        ...
        System.out.println("Puedes drenar un HashSet loco, ordenarlo en la tubería y volcarlo en un ArrayList bonito y organizado.");
    }
    ...
    public static void ejercicio() {
        ...
        // Ya que la clase Mision NO TIENE natural order, usa .sorted( (m1, m2) -> ... ) en la tubería
        ...
        if (misionesDrenadasYOrdenadas != null && misionesDrenadasYOrdenadas.size() == 3 && 
            ...
            System.out.println(">> ¡CORRECTO! Has demostrado que no importa dónde empieces, Stream siempre domina el caos.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] El flujo resultante debe ser una lista de 3 misiones, la de oro 90000 primera.");
        }
    }
}
