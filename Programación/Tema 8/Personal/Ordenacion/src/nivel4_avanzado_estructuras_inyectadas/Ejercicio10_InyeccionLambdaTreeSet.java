...
public class Ejercicio10_InyeccionLambdaTreeSet {
    ...
    public static void demostracion() {
        ...
        System.out.println("Por defecto, un TreeSet usa el orden 'Comparable' inyectado en la clase (El NIVEL, en nuestro Aventurero).");
    ...
    public static void ejercicio() {
        ...
        // TODO: Crea un nuevo TreeSet llamado 'realeza', pero en sus paréntesis inyéctale una Lambda.
        // La lambda debe ordenar a los Aventureros por su ORO (de mayor riqueza a menor riqueza).
        ...
        if (realeza != null && realeza.size() == 3 && realeza.iterator().next().getNombre().equals("Noble")) {
            System.out.println(">> ¡CORRECTO! Has hackeado la base de existencia del TreeSet con una Lambda.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] Asegúrate de que realeza esté inicializado con un TreeSet que compare Oro en orden inverso (mayor primero).");
        }
    }
}
