...
public class Ejercicio04_LambdaSortSintaxis {
    ...
    public static void ejercicio() {
        ...
        // TODO: Ordena la variable 'tablon'. Pero esta vez debe ser de MAYOR RANGO a MENOR RANGO alfabético 
        ...
        if (tablon.size() == 3 && tablon.get(0).getRango().equals("S") && tablon.get(2).getRango().equals("A")) {
            System.out.println(">> ¡CORRECTO! Una línea láser y brillante. Ya estás hablando en dialecto Lambda.\033[0;32m [OK]\033[0m");
        } else {
