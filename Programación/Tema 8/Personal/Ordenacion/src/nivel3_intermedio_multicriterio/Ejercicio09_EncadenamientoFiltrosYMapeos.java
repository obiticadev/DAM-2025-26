...
public class Ejercicio09_EncadenamientoFiltrosYMapeos {
    ...
    public static void demostracion() {
        ...
        System.out.println("Con el comando intermedio `.map( Función )` puedes extraer, por ejemplo, los DNIs de una lista de Personas.");
        System.out.println("Tu tubería entra como Stream<Persona> y, cruzando el map(), se convierte en un Stream<String>.");
    }
    ...
    public static void ejercicio() {
        ...
        // TODO: El contable del gremio NO necesita los objetos 'Aventurero' que pesan en memoria.
        // Solo quiere un simple ArrayList<String> con los NOMBRES.
        // Condición 1: Filtra solo a los que estén VIVOS.
        // Condición 2: Usa .map( a -> a.getNombre() ) para mutar el stream a tipo String.
        // Condición 3: Ordénalos alfabéticamente llamando a .sorted() (Como ya son Strings, usan orden natural solos).
        // Recolectores: toList().
        
        List<String> nombresVivosOrdenados = null; // <- Modifica aquí.
        ...
        if (nombresVivosOrdenados != null && nombresVivosOrdenados.size() == 3 && 
            ...
            System.out.println(">> ¡CORRECTO! Has extraído, mutado, ordenado y finalizado una base de datos en 1 sola línea maestra.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] Revisa el Pipeline. Debe haber 3 Nombres (Strings) ordenados de la A a la Z, excluyendo al ladrón muerto Tomy.");
        }
    }
}
