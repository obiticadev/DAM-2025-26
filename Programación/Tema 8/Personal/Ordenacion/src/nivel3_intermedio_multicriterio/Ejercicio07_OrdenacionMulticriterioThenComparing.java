...
public class Ejercicio07_OrdenacionMulticriterioThenComparing {
    ...
    public static void demostracion() {
        ...
        System.out.println("Comparator<Obj> multiple = Comparator.comparing(a -> a.getOro()).thenComparing(a -> a.getNivel());");
    ...
    public static void ejercicio() {
        ...
        // Ordena la lista de forma que el criterio PRINCIPAL sea la claseClase (Alfabético).
        // Y en caso de EMPATE de Clase (Como Arthur y Lancelot), ordénalos por NIVEL de menor a mayor.
        
        Comparator<Aventurero> miCriterio = Comparator
                                                .comparing( (Aventurero a) -> "" ) /* CORRIGE ESTO */
                                                .thenComparing( (Aventurero a) -> 0 ); /* CORRIGE ESTO */
        ...
        if (gremio.size() == 4 && 
            ...
            System.out.println(">> ¡CORRECTO! Has ordenado alfabéticamente por Clase y desempatado por Nivel.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] Orden incorrecto. Revisa el comparing y thenComparing. Debería ir: Arquero(Robin) -> Guerrero(Arthur) -> Guerrero(Lancelot) -> Mago(Merlin).");
        }
    }
}
