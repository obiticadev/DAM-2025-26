...
public class Ejercicio13_CollectAgrupacionYParticion {
    ...
    public static void demostracion() {
        ...
        System.out.println("¿Tienes 1000 aventureros desordenados y te piden separarlos por 'Clase' (Mago, Guerrero...) en listas independientes?");
        System.out.println("Puedes ordenarlo a Java y creará un Diccionario donde las Claves son la Clase, y los Valores son Sub-Listas con sus pjs.");
        System.out.println("Map<Tipos, List<Obj>> m = lista.stream().collect( Collectors.groupingBy( a -> a.getParam() ) );");
    }
    ...
    public static void ejercicio() {
        ...
        // TODO: Extrae el stream de la multitud y haz que caiga en el recolector groupingBy.
        // Agrupa los jugadores en listas usando su 'claseClase' como Llave separadora (e.g. "Mago", "Guerrero").
        ...
        // --- VALIDACIÓN ---
        if (escuadrones != null && escuadrones.size() == 3 && escuadrones.get("Guerrero").size() == 2 && escuadrones.get("Mago").size() == 2) {
            System.out.println(">> ¡CORRECTO! Una operación de agrupación que costaría 15 líneas en Java <= 7 ejecutada limpiamente en 1.\033[0;32m [OK]\033[0m");
