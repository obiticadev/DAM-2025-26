...
public class Ejercicio14_MetodosDeReferencia {
    ...
    public static void demostracion() {
        ...
        System.out.println(
                "Cuando tu lambda '((Aventurero a) -> a.getNombre())' es TAN sencilla que literalmente NO hace");
        System.out.println(
                "ninguna operación salvo coger un objeto y pasarlo de largo llamando a un método suyo, los puristas");
    ...
    public static void ejercicio() {
        ...
        // Usa '.map( Aventurero::getNombre )' usando el Método de Referencia :: para
        // extraer sólo el Nombre de cada uno.
        // Guárdalo en una List usando '.toList()' directo o
        // 'collect(Collectors.toList())'.

        List<String> nombresLimpios = null; // <- Escribe aquí
        nombresLimpios = nomina.stream()
        ...
        if (nombresLimpios != null && nombresLimpios.size() == 2 && nombresLimpios.get(0).equals("Arthur")) {
            System.out.println(
                    ">> ¡CORRECTO! Has subido al peldaño visual definitivo del código Senior con los Métodos de Referencia.\033[0;32m [OK]\033[0m");
        } else {
