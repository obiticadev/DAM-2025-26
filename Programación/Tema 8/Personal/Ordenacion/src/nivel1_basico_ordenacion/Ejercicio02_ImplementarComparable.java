...
public class Ejercicio02_ImplementarComparable {
    ...
    public static void demostracion() {
        ...
        System.out.println("Al hacer esto, Collections.sort(listaAventureros) dejará de dar error, pues sabe qué usar.");
    }
    ...
    public static void ejercicio() {
        ...
        // TODO: En Aventurero se fijó que el orden natural debe ser por Nivel DESCENDENTE.
        // Es decir, Aragorn(80) debería ir primero y Frodo(15) al final. 
        // Ejecuta la ordenación base y comprueba si funciona con 1 sola línea de código estática:
        
        

        // --- VALIDACIÓN ---
        if (gremio.size() == 4 && gremio.get(0).getNombre().equals("Aragorn") && gremio.get(3).getNombre().equals("Frodo")) {
            System.out.println(">> ¡CORRECTO! Haz aprovechado el ADN Comparable de tu clase pesada.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] El gremio no está ordenado por Nivel Descendente. ¿Llamaste a Collections.sort?");
        }
    }
}
