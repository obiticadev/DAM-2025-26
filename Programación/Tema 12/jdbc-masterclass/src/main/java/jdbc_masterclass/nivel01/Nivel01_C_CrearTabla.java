...
public class Nivel01_C_CrearTabla {
     ...
     * Cuando creamos o alteramos tablas, la instrucción correcta es execute() y no executeQuery().
     * 
     * @param conn Conexión activa
     * @return true si la tabla se crea con éxito, false si hay error.
     */
    public static boolean inicializarTablaLibros(Connection conn) {
        String sql = """
        ...
        // TODO: Retorna true si todo va bien. Captura SQLException y retorna false si falla.
