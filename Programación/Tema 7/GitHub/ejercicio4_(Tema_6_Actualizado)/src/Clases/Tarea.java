...
public class Tarea {
    ...
    public boolean tareaVencida(){
        LocalDateTime fechaCompleta = LocalDateTime.of(this.fecha.getYear(), this.fecha.getMonth(), this.fecha.getDayOfMonth(), this.hora.getHour(), this.hora.getMinute(), this.hora.getSecond());
