 ...
 * 
 * Objetivo: Usar .and(), .or(), .negate() para combinar predicados reutilizables.
 */
public class Ejercicio07_ComposicionPredicados {
    ...
    public static void ejercicio() {
        ...
        // TODO 1: Crea un Predicate 'usaJava' que compruebe si el lenguaje principal es "Java"
        Predicate<Empleado> usaJava = null; // <- Escribe aquí

        // TODO 2: Crea un Predicate 'estaActivo' que compruebe si el empleado está activo
        Predicate<Empleado> estaActivo = null; // <- Escribe aquí

        // TODO 3: Combínalos con .and() para crear 'javaYActivo'
        Predicate<Empleado> javaYActivo = null; // <- Escribe aquí

        // TODO 4: Crea un Predicate 'noJavaYActivo' usando .negate() sobre usaJava, combinado con estaActivo
        Predicate<Empleado> noJavaYActivo = null; // <- Escribe aquí
        ...
        if (javaOk && noJavaOk) {
            System.out.println(">> CORRECTO: Has construido filtros como piezas de LEGO reutilizables.\033[0;32m [OK]\033[0m");
        } else {
            System.err.println(">> [ERROR] JavaYActivo debería dar 2 (Ana, Marta). NoJavaYActivo debería dar 2 (Carlos, Lucía).");
        }
    }
}
