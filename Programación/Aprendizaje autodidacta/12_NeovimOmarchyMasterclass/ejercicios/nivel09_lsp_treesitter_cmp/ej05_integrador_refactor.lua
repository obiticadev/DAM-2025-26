...
local function calcularPrecio(base, descuento_var)
    return base - (base * descuento_var)
end

local function mensaje_a_completar()
    return "TODO: rellenar"
end

-- Invocaciones
local p1 = calcularPrecio(100, 0.1)
local p2 = calcularPrecio(50, 0.2)
print(p1)
print(p2)
