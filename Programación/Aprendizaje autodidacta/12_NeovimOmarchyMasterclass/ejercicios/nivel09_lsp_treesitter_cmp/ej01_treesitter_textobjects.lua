...
local function funcion_a_borrar()
    print("esta función se borra entera")
    return 999
end
...
local function funcion_argumentos(a, b, c)
    return a + b + c
end

local function funcion_final_a_eliminar()
    print("se elimina entera")
end
