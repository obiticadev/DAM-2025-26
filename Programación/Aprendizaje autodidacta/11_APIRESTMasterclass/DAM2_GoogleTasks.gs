...
function PLAN() {
  return [
    ...
    { inicio: '2026-07-01', titulo: 'S1 · Java moderno (base)', teoria: 'teoria/01_Java_Moderno_para_APIs.md', items: [
      ej('011','b01_java/Ej011_Records.java','b01_java','Java base','—','P0','record inmutable como DTO'),
      ej('012','b01_java/Ej012_OptionalSafeAccess.java','b01_java','Java base','—','P0','Optional sin NullPointer'),
      ej('013','b01_java/Ej013_StreamsBasics.java','b01_java','Java base','—','P0','map/filter/collect'),
      ej('014','b01_java/Ej014_StreamsAdvanced.java','b01_java','Java base','—','P0','reduce, flatMap, Collectors'),
      ej('015','b01_java/Ej015_GenericsRepository.java','b01_java','Java base','—','P0','genéricos y T acotados'),
      ej('017','b01_java/Ej017_FunctionalInterfaces.java','b01_java','Java base','—','P0','Function/Predicate/Supplier'),
      ej('019','b01_java/Ej019_ExceptionsAndTryWith.java','b01_java','Java base','—','P0','excepciones y try-with-resources'),
      ej('020','b01_java/Ej020_DateTimeApi.java','b01_java','Java base','—','P0','java.time'),
      ej('022','b01_java/Ej022_EqualsHashCodeContracts.java','b01_java','Java base','—','P0','contratos equals/hashCode'),
      ej('016','b01_java/Ej016_WildcardsVariance.java','b01_java','Java base','—','P2','? extends / ? super'),
      ej('018','b01_java/Ej018_SealedPatternMatching.java','b01_java','Java base','—','P2','sealed + switch patrones'),
      ej('021','b01_java/Ej021_ConcurrencyBasics.java','b01_java','Java base','—','P2','aperitivo de PSP'),
    ]},
    ...
    { inicio: '2026-07-08', titulo: 'S2 · AD RA1 ficheros', teoria: 'teoria/26_IO_Ficheros_NIO2.md', items: [
      ...
      ej('143','b16_xml/Ej143_JaxbBinding.java','b16_xml','AD (0486)','RA1','P0','JAXB objeto<->XML'),
      ej('144','b16_xml/Ej144_JacksonXml.java','b16_xml','AD (0486)','RA1','P0','Jackson XML'),
      ej('148','b16_xml/Ej148_CsvImportExport.java','b16_xml','AD (0486)','RA1','P0','import/export CSV'),
      ej('213','b26_io/Ej213TempFilesAndChannels.java','b26_io','AD (0486)','RA1','P2','FileChannel/ByteBuffer'),
      ej('145','b16_xml/Ej145_DomSaxParsing.java','b16_xml','AD (0486)','RA1','P2','DOM vs SAX'),
      ej('146','b16_xml/Ej146_XmlEndpoint.java','b16_xml','AD (0486)','RA1','P2','endpoint que produce XML'),
      ej('147','b16_xml/Ej147_FileBackedRepository.java','b16_xml','AD (0486)','RA1','P2','repo persistido en fichero'),
    ...
    { inicio: '2026-07-15', titulo: 'S3 · AD RA2 JDBC + procedimientos', teoria: 'teoria/11_JDBC_Profundo.md', items: [
      ej('093','b11_jdbc/Ej093_ConnectionDriverManager.java','b11_jdbc','AD (0486)','RA2','P0','Connection, drivers'),
      ej('094','b11_jdbc/Ej094_StatementVsPrepared.java','b11_jdbc','AD (0486)','RA2','P0','inyección SQL, PreparedStatement'),
      ej('095','b11_jdbc/Ej095_ResultSetMapping.java','b11_jdbc','AD (0486)','RA2','P0','ResultSet -> objeto'),
      ej('096','b11_jdbc/Ej096_CrudDao.java','b11_jdbc','AD (0486)','RA2','P0','DAO CRUD con JDBC puro'),
      ej('097','b11_jdbc/Ej097_TransactionsCommitRollback.java','b11_jdbc','AD (0486)','RA2','P0','transacciones manuales'),
      ej('099','b11_jdbc/Ej099_ConnectionPooling.java','b11_jdbc','AD (0486)','RA2','P0','pool (HikariCP)'),
      ej('100','b11_jdbc/Ej100_JdbcTemplate.java','b11_jdbc','AD (0486)','RA2','P0','JdbcTemplate de Spring'),
      ...
      ej('098','b11_jdbc/Ej098_BatchOperations.java','b11_jdbc','AD (0486)','RA2','P2','inserción por lotes'),
      ej('101','b11_jdbc/Ej101_RowMapperAndExtractor.java','b11_jdbc','AD (0486)','RA2','P2','RowMapper/ResultSetExtractor'),
      ej('102','b11_jdbc/Ej102_NamedParameterJdbc.java','b11_jdbc','AD (0486)','RA2','P2','NamedParameterJdbcTemplate'),
    ...
    { inicio: '2026-07-22', titulo: 'S4 · AD RA3 JPA core + relaciones', teoria: 'teoria/12_Spring_Data_JPA.md', items: [
      ej('103','b12_jpa/Ej103_EntityMapping.java','b12_jpa','AD (0486)','RA3','P0','@Entity/@Id/@Column'),
      ej('104','b12_jpa/Ej104_IdGenerationStrategies.java','b12_jpa','AD (0486)','RA3','P0','@GeneratedValue'),
      ej('105','b12_jpa/Ej105_JpaRepository.java','b12_jpa','AD (0486)','RA3','P0','JpaRepository CRUD'),
      ej('106','b12_jpa/Ej106_DerivedQueryMethods.java','b12_jpa','AD (0486)','RA3','P0','queries por nombre de método'),
      ej('107','b12_jpa/Ej107_JpqlQueries.java','b12_jpa','AD (0486)','RA3','P0','@Query JPQL'),
      ej('110','b12_jpa/Ej110_EntityLifecycleCallbacks.java','b12_jpa','AD (0486)','RA3','P0','@PrePersist/@PreUpdate'),
      ej('111','b12_jpa/Ej111_EnumAndEmbeddable.java','b12_jpa','AD (0486)','RA3','P0','@Enumerated/@Embeddable'),
      ej('115','b13_rel/Ej115_OneToOne.java','b13_rel','AD (0486)','RA3','P0','@OneToOne'),
      ej('116','b13_rel/Ej116_OneToManyManyToOne.java','b13_rel','AD (0486)','RA3','P0','@OneToMany/@ManyToOne'),
      ej('117','b13_rel/Ej117_ManyToManyJoinTable.java','b13_rel','AD (0486)','RA3','P0','@ManyToMany'),
      ej('120','b13_rel/Ej120_FetchLazyEager.java','b13_rel','AD (0486)','RA3','P0','LAZY vs EAGER'),
      ej('121','b13_rel/Ej121_NPlusOneProblem.java','b13_rel','AD (0486)','RA3','P0','diagnosticar N+1'),
      ej('108','b12_jpa/Ej108_NativeQueries.java','b12_jpa','AD (0486)','RA3','P2','SQL nativo'),
      ej('109','b12_jpa/Ej109_ModifyingQueries.java','b12_jpa','AD (0486)','RA3','P2','@Modifying update/delete'),
      ej('112','b12_jpa/Ej112_PersistenceContext.java','b12_jpa','AD (0486)','RA3','P2','contexto de persistencia, flush'),
      ej('113','b12_jpa/Ej113_EqualsHashCodeEntities.java','b12_jpa','AD (0486)','RA3','P2','identidad de entidades'),
      ej('114','b12_jpa/Ej114_DtoConstructorProjection.java','b12_jpa','AD (0486)','RA3','P2','proyección por constructor'),
      ej('118','b13_rel/Ej118_BidirectionalSync.java','b13_rel','AD (0486)','RA3','P2','sincronizar lados de relación'),
      ej('119','b13_rel/Ej119_CascadeTypes.java','b13_rel','AD (0486)','RA3','P2','cascade y orfandad'),
      ej('122','b13_rel/Ej122_JoinFetchAndEntityGraph.java','b13_rel','AD (0486)','RA3','P2','JOIN FETCH, EntityGraph'),
    ...
    { inicio: '2026-07-29', titulo: 'S5 · AD RA3 JPA avanzado + consultas', teoria: 'teoria/14_JPA_Avanzado.md', items: [
      ej('123','b14_jpaadv/Ej123_TransactionPropagation.java','b14_jpaadv','AD (0486)','RA3','P0','propagación de transacciones'),
      ej('124','b14_jpaadv/Ej124_IsolationLevels.java','b14_jpaadv','AD (0486)','RA3','P0','niveles de aislamiento'),
      ej('125','b14_jpaadv/Ej125_OptimisticLocking.java','b14_jpaadv','AD (0486)','RA3','P0','@Version'),
      ej('128','b14_jpaadv/Ej128_Auditing.java','b14_jpaadv','AD (0486)','RA3','P0','@CreatedDate/@LastModifiedBy'),
      ej('129','b14_jpaadv/Ej129_SoftDelete.java','b14_jpaadv','AD (0486)','RA3','P0','borrado lógico'),
      ej('133','b15_query/Ej133_Pagination.java','b15_query','AD (0486)','RA3','P0','Pageable/Page'),
      ej('134','b15_query/Ej134_Sorting.java','b15_query','AD (0486)','RA3','P0','Sort multinivel'),
      ej('136','b15_query/Ej136_DynamicFiltering.java','b15_query','AD (0486)','RA3','P0','filtros por query params'),
      ej('137','b15_query/Ej137_Specifications.java','b15_query','AD (0486)','RA3','P0','Specification (Criteria)'),
      ej('141','b15_query/Ej141_AggregationsGroupBy.java','b15_query','AD (0486)','RA3','P0','agregaciones y GROUP BY'),
      ej('126','b14_jpaadv/Ej126_PessimisticLocking.java','b14_jpaadv','AD (0486)','RA3','P2','LockModeType'),
      ej('127','b14_jpaadv/Ej127_SecondLevelCache.java','b14_jpaadv','AD (0486)','RA3','P2','caché de 2º nivel'),
      ej('130','b14_jpaadv/Ej130_InheritanceStrategies.java','b14_jpaadv','AD (0486)','RA3','P2','herencia de entidades'),
      ej('131','b14_jpaadv/Ej131_FlushModesBatching.java','b14_jpaadv','AD (0486)','RA3','P2','flush, batch JPA'),
      ej('132','b14_jpaadv/Ej132_FlywayMigrations.java','b14_jpaadv','AD (0486)','RA3','P2','migraciones de esquema'),
      ej('135','b15_query/Ej135_SliceVsPage.java','b15_query','AD (0486)','RA3','P2','Slice vs Page'),
      ej('138','b15_query/Ej138_CriteriaApi.java','b15_query','AD (0486)','RA3','P2','Criteria API tipada'),
      ej('139','b15_query/Ej139_QueryByExample.java','b15_query','AD (0486)','RA3','P2','Query by Example'),
      ej('140','b15_query/Ej140_InterfaceProjections.java','b15_query','AD (0486)','RA3','P2','proyecciones por interfaz'),
      ej('142','b15_query/Ej142_KeysetPagination.java','b15_query','AD (0486)','RA3','P2','paginación por cursor'),
    ...
    { inicio: '2026-08-05', titulo: 'S6 · AD RA5 Mongo + RA6 componentes (AD 6/6)', teoria: 'teoria/17_NoSQL_MongoDB.md', items: [
      ej('149','b17_nosql/Ej149_MongoDocumentMapping.java','b17_nosql','AD (0486)','RA5','P0','@Document/@Id'),
      ej('150','b17_nosql/Ej150_MongoRepository.java','b17_nosql','AD (0486)','RA5','P0','MongoRepository CRUD'),
      ej('151','b17_nosql/Ej151_MongoTemplateQueries.java','b17_nosql','AD (0486)','RA5','P0','MongoTemplate, Query'),
      ej('153','b17_nosql/Ej153_AggregationPipeline.java','b17_nosql','AD (0486)','RA5','P0','pipeline de agregación'),
      ...
      ej('152','b17_nosql/Ej152_EmbeddedVsReferences.java','b17_nosql','AD (0486)','RA5','P2','embebido vs referencias'),
      ej('154','b17_nosql/Ej154_MongoRestEndpoint.java','b17_nosql','AD (0486)','RA5','P2','API REST sobre Mongo'),
    ...
    { inicio: '2026-08-26', titulo: 'S9 · cierre PSP (RA4/RA5) + repaso', teoria: 'teoria/05_Controllers_REST.md', items: [
      ej('001','b00_http/Ej001_HttpRequestParser.java','b00_http','PSP (0490)','RA4','P0','anatomía de la request HTTP'),
      ej('004','b00_http/Ej004_HttpMethodsSemantics.java','b00_http','PSP (0490)','RA4','P0','idempotencia y seguridad de verbos'),
      ej('045','b05_web/Ej045_HelloController.java','b05_web','PSP (0490)','RA4','P0','@RestController/@GetMapping'),
      ej('048','b05_web/Ej048_RequestBodyPost.java','b05_web','PSP (0490)','RA4','P0','@RequestBody, 201 Created'),
      ej('053','b05_web/Ej053_CrudInMemory.java','b05_web','PSP (0490)','RA4','P0','CRUD REST completo (cierra RA4)'),
      ej('155','b18_sec/Ej155_SecurityFilterChain.java','b18_sec','PSP (0490)','RA5','P0','config Spring Security'),
      ej('157','b18_sec/Ej157_PasswordEncoder.java','b18_sec','PSP (0490)','RA5','P0','BCrypt'),
      ej('159','b18_sec/Ej159_JwtIssue.java','b18_sec','PSP (0490)','RA5','P0','emisión de JWT'),
      ej('161','b18_sec/Ej161_RoleBasedAccess.java','b18_sec','PSP (0490)','RA5','P0','roles, @PreAuthorize (cierra RA5)'),
