...
class Ej15_PrintWriterFormateadoTest {
    ...
    @Test
    @DisplayName("escribirLog: genera N lineas formateadas")
    ...
    @Test
    @DisplayName("escribirLog: arrays distintos lanza excepcion")
    ...
    @Test
    @DisplayName("generarInventario: contiene productos")
    ...
    @Test
    @DisplayName("generarInventario: arrays distintos lanza excepcion")
    ...
    @Test
    @DisplayName("escribirConPrintln: genera lineas correctas")
    ...
    @Test
    @DisplayName("informeVentas: contiene fecha y total")
    ...
    @Test
    @DisplayName("anadirAlLog: no borra contenido anterior")
    ...
    @Test
    @DisplayName("tablaMultiplicar: genera 10 lineas")
    ...
    @Test
    @DisplayName("tablaMultiplicar: contiene resultados correctos")
    ...
    @Test
    @DisplayName("lineasEsperadas: devuelve el numero de mensajes")
    void lineasEsperadas_correcto() {
        assertEquals(5, Ej15_PrintWriterFormateado.lineasEsperadas(5));
    }

    @Test
    @DisplayName("lineasEsperadas: 0 mensajes devuelve 0")
