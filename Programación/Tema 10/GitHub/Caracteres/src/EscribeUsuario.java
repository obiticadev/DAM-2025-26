...
/*
 * CharSequence es una interfaz en Java que representa una secuencia de
 * caracteres de forma abstracta.
 * Permite trabajar con cualquier tipo de secuencia de caracteres de manera
 * uniforme, sin importar su implementación (String, StringBuilder,
 * StringBuffer, etc.).
 ...
 * }
 * Muchos métodos en Java aceptan CharSequence en lugar de String, permitiendo
 * mayor flexibilidad.
 * 
