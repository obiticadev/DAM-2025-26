...
public class DAOParking {
    ...
    private void cargarDatos() throws MiExcepcion {
        ...
        VehiculoAparcado c2 = new Coche("0000ZZZ", "Seat", "Cordoba", LocalTime.now().minusHours(3).minusMinutes(15), 3, false);
        VehiculoAparcado c3 = new Coche("9876XYZ", "Renault", "Clio", LocalTime.now().minusMinutes(45), 5, true);
        VehiculoAparcado c4 = new Coche("4512BTR", "Toyota", "Corolla", LocalTime.now().minusHours(1).minusMinutes(30), 5, false);
        ...
        VehiculoAparcado m3 = new Moto("3333DDD", "Kawasaki", "Ninja", LocalTime.now().minusHours(2).minusMinutes(15), 400);
