<style>
    ...
    /* 2. REGLAS PARA TÍTULOS */
    /* El Título principal (H1) NO fuerza salto, para arreglar el inicio */
    h1 {
    ...
    /* Los Capítulos (H2) SÍ fuerzan página nueva (1.0, 2.0...) */
    h2 {
    ...
    /* 3. REGLA MAESTRA ANTICORTE (La Clase .bloque) */
    .bloque {
        /* Esto obliga al navegador a tratar el bloque como una unidad indivisible */
        page-break-inside: avoid !important;
        break-inside: avoid !important;
        
        /* Truco para que Chromium respete el 'avoid' */
        display: inline-block; 
        width: 100%;
        
        /* Correcciones estéticas por usar inline-block */
        vertical-align: top;
        margin-bottom: 15px; /* Espacio entre secciones */
    }

    /* Evita que un título se separe de su párrafo dentro de un bloque */
    h3, h4, h5 {
        page-break-after: avoid;
        margin-top: 0; /* Pegado al techo del bloque */
        padding-top: 10px;
    }
</style>

<!-- SECCIÓN 1: LEYENDA (Sin salto previo) -->
<div class="bloque">
